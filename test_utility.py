...
def test_data_split(feature_target_sample):
    ...
    assert len(return_tuple) == 4, f"Expected 4 elements, got {len(return_tuple)}"

    # Optionally, you can add further assertions here to verify other properties of each element
    # For example, you might want to check the types or shapes of each part of the tuple if applicable
